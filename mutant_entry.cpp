...
proteum_style_column_num_(proteum_style_column_num), function_decl_name_(function_decl_name), src_mgr_(src_mgr)
{
  // cout << "cp MutantEntry\n";
...
std::string MutantEntry::getFunctionDeclName() const
{
